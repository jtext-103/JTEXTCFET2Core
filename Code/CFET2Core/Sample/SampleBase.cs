...
namespace Jtext103.CFET2.Core.Sample
{
    ...
    public class SampleBase<T> : ISample
    {
        ...
        */
        ...
        /// </summary>
        public Dictionary<string, object> Context { get; set; } = new Dictionary<string, object>(StringComparer.InvariantCultureIgnoreCase);
        ...
        public string Path
        {
            ...
            {
                object path;
                //path = Context[KeyOfPath];
                //if(Context.ContainsKey(KeyOfPath))
        ...
        public virtual ResourceTypes ResourceType
        {
            ...
            {
                object type;
                if (Context.ContainsKey(KeyOfResourceType))
                {
                    type = Convert.ToInt32(Context[KeyOfResourceType]);
                }
                else
                {
                    type = ResourceTypes.Abstract;
                }
        ...
        public bool IsRemote
        {
            get
            {
                ...
                {
                    //isRemote = Context[KeyOfIsRemote];
